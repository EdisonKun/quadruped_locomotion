...
valuetype generate_rh_motion_2(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(0.5 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.15,  y_start - 2 * y_direction, z_start + height_1));
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.15,  y_start - 2 * y_direction, z_start + adjust_height));
    ...
    j = 4;
    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.15,  y_start - 2 * y_direction, z_start + height_2 + adjust_height));

    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + 0.15,  y_start - 2 * y_direction, z_start + height_2));
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + 0.05,  y_start - 2 * y_direction, z_start + height_2));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.05, y_start, z_start + height_2 + adjust_height));
    ...
    valuetype pos_final;
    pos_final << x_start + 0 * forward_d - 0.05, y_start, z_start + height_2 + adjust_height;
...
valuetype generate_lf_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lf_joint_positions, std::vector<valuetype>& lf_foot_position)
{
    ...
    times_of_lf[j].push_back(period_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d - walking_dis, y_start, z_start));
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start - forward_d - walking_dis, y_start, z_start));
    lf_leg_trajectory[j].fitCurve(times_of_lf[j], lf_leg_position[j]);
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start - 3 * forward_d - walking_dis, y_start + 2 * y_direction, z_start));
    ...
    valuetype pos_final;
    pos_final << x_start - 3 * forward_d - walking_dis, y_start + 2 * y_direction, z_start;
    ...
    while(dt <= (3 * period_t + 3 * adjust_t))
    {
        if(dt <= adjust_t)
        {
            lf_leg_trajectory[0].evaluate(evaluate_value, dt);
        }else if(dt > adjust_t && dt <= (adjust_t + period_t))
        {
          dt_ = dt - (adjust_t);
            lf_leg_trajectory[1].evaluate(evaluate_value, dt_);
        }else if(dt > (adjust_t + period_t) && dt <=(period_t + 2 * adjust_t) )
        {
...
valuetype generate_rf_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d, rf_y_start, rf_z_start + 0.22));
    ...
    times_of_rf[j].push_back(0.5 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d + walking_dis, rf_y_start, rf_z_start + 0.22));
    ...
    times_of_rf[j].push_back(0.25 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d + walking_dis, rf_y_start, rf_z_start));
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + walking_dis - 3 * forward_d, rf_y_start + 2 * y_direction, rf_z_start));
    ...
    valuetype pos_final;
    pos_final << rf_x_start + walking_dis - 3 * forward_d, rf_y_start + 2 * y_direction, rf_z_start;
...
valuetype generate_lh_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    times_of_lh[j].push_back(period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d - 0.05, y_start, z_start));
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start  - 3 * forward_d - 0.05, y_start + 2 * y_direction, z_start));
    ...
    times_of_lh[j].push_back(0.25 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start  - 3 * forward_d - 0.05, y_start + 2 * y_direction, z_start + 0.22));
    ...
    times_of_lh[j].push_back(0.5 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start  - 3 * forward_d - 0.05 + walking_dis, y_start + 2 * y_direction, z_start + 0.22));
    ...
    times_of_lh[j].push_back(0.25 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start  - 3 * forward_d - 0.05 + walking_dis, y_start + 2 * y_direction, z_start + height_2));

    lh_leg_trajectory[j].fitCurve(times_of_lh[j], lh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start  - 3 * forward_d + walking_dis - 0.05, y_start + 2 * y_direction, z_start + height_2;
...
valuetype generate_rh_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d - small_dis, y_start, z_start));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start  - forward_d - small_dis, y_start, z_start));
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start  - forward_d - small_dis, y_start, z_start + 0.2));
    ...
    rh_leg_position[j].push_back(valuetype(x_start  - forward_d - small_dis + walking_dis, y_start, z_start + 0.2));
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start  - forward_d - small_dis + walking_dis, y_start, z_start + height_2));
   ...
   times_of_rh[j].push_back(adjust_t);
   rh_leg_position[j].push_back(valuetype(x_start  - 3 * forward_d - small_dis + walking_dis, y_start + 2 * y_direction, z_start + height_2));
  ...
  rh_leg_trajectory[j].fitCurve(times_of_rh[j], rh_leg_position[j]);
    ...
    valuetype pos_final;
    pos_final << x_start  - 3 * forward_d - small_dis + walking_dis, y_start + 2 * y_direction, z_start + height_2;
