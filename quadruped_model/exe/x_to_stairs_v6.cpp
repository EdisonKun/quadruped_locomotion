...
valuetype generate_lf_motion_1(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lf_joint_positions, std::vector<valuetype>& lf_foot_position)
{
    ...
    lf_leg_position[j].push_back(valuetype(x_start - step_dis / 2 + forward_d, y_start + y_direction, z_start + 0.05));
    ...
    start_pose.getPosition() << x_start - step_dis / 2 + forward_d, y_start + y_direction, z_start + 0.05;
    QK.InverseKinematicsSolve(start_pose.getPosition(), LimbEnum::LF_LEG, start_joints, start_joints, "IN_LEFT");

    final_pose.getPosition() << x_start + step_dis / 2 + forward_d, y_start + y_direction, z_start + height_2 + 0.05;
...
//        std::cout << "final joint is " << final_joints << std::endl;
    ...
    j = 10;
    times_of_lf[j].push_back(0.0);
    lf_leg_position[j].push_back(valuetype(x_start + step_dis / 2 + forward_d, y_start + y_direction, z_start + height_2 + 0.05));

    times_of_lf[j].push_back(0.2 * period_t);
    lf_leg_position[j].push_back(valuetype(x_start + step_dis / 2 + forward_d, y_start + y_direction, z_start + height_2 - adjust_height));

    lf_leg_trajectory[j].fitCurve(times_of_lf[j], lf_leg_position[j]);


    //step 3: com moves foward and left
    j = 2;
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + step_dis / 2 - forward_d, y_start - y_direction, z_start + height_2));
    ...
    lf_leg_position[j].push_back(valuetype(x_start + step_dis / 6 - forward_d, y_start - y_direction, z_start + height_2));
    lf_leg_trajectory[j].fitCurve(times_of_lf[j], lf_leg_position[j]);
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + step_dis / 6 + forward_d, y_start - y_direction, z_start + height_2 - adjust_height));
    ...
    valuetype pos_final;
    pos_final << x_start - step_dis / 2 - forward_d, y_start + y_direction, z_start + height_2;
...
valuetype generate_rf_motion_1(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    std::cout << "rf start is " << rf_x_start + step_dis / 6 - forward_d << rf_y_start << rf_z_start <<std::endl;
    std::cout << "rf final is " << valuetype(rf_x_start + step_dis / 6 + forward_d, rf_y_start, rf_z_start + adjust_height) << std::endl;
    ...
    rf_leg_position[j].push_back(valuetype(rf_x_start - step_dis / 2 + forward_d, rf_y_start - y_direction, rf_z_start + height_1));
    ...
    start_pose.getPosition() << rf_x_start - step_dis / 2 + forward_d, rf_y_start - y_direction, rf_z_start + height_1;
    QK.InverseKinematicsSolve(start_pose.getPosition(), LimbEnum::RF_LEG, start_joints, start_joints, "OUT_LEFT");

    final_pose.getPosition() << rf_x_start + 0.1 + forward_d, rf_y_start - y_direction, rf_z_start + height_2 + 0.05;// not move too long.
    ...
    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0.1 + forward_d, rf_y_start - y_direction, rf_z_start + height_2 + 0.05));

    times_of_rf[j].push_back(0.2 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0.1 + forward_d, rf_y_start - y_direction, rf_z_start + height_2 - adjust_height));

    rf_leg_trajectory[j].fitCurve(times_of_rf[j], rf_leg_position[j]);
    //step 7: com moves to forward;
    j = 6;
    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0.1 + forward_d, rf_y_start - y_direction, rf_z_start + height_2 - adjust_height));

    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0.1 - forward_d, rf_y_start + y_direction, rf_z_start + height_2));
    ...
    times_of_rf[j].push_back(period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start - 0.1 + 0.1 - forward_d, rf_y_start + y_direction, rf_z_start + height_2));

    rf_leg_trajectory[j].fitCurve(times_of_rf[j], rf_leg_position[j]);

    valuetype pos_final;
    pos_final << rf_x_start - 0.1 + 0.1 - forward_d, rf_y_start + y_direction, rf_z_start + height_2;
...
valuetype generate_lh_motion_1(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    std::cout << "lh start is " << valuetype(x_start + step_dis / 2 - forward_d, y_start, z_start) <<std::endl;
    std::cout << "lh final is " << valuetype(x_start + step_dis / 2 + forward_d, y_start, z_start) << std::endl;
    ...
    lh_leg_position[j].push_back(valuetype(x_start - step_dis / 2 - forward_d, y_start + y_direction, z_start + height_1));
...
valuetype generate_rh_motion_1(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    rh_leg_position[j].push_back(valuetype(x_start - step_dis / 2 - forward_d, y_start - y_direction, z_start + height_1));
...
valuetype generate_lf_motion_2(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lf_joint_positions, std::vector<valuetype>& lf_foot_position)
{
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d, y_start, z_start + adjust_height));
    ...
    times_of_lf[j].push_back(0.2 * period_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + walking_dis, y_start, z_start + height_2 + adjust_height));
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis, y_start - 2 * y_direction, z_start + height_2));
    ...
    times_of_lf[j].push_back(period_t);
    lf_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis - 0.1, y_start - 2 * y_direction, z_start + height_2));
    lf_leg_trajectory[j].fitCurve(times_of_lf[j], lf_leg_position[j]);
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + walking_dis - 0.1, y_start - 2 * y_direction, z_start + height_2 + adjust_height));
    ...
    times_of_lf[j].push_back(period_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + walking_dis - 0.2, y_start - 2 * y_direction, z_start + height_2 + adjust_height));
...
valuetype generate_rf_motion_2(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d, rf_y_start, rf_z_start + adjust_height));
    ...
    times_of_rf[j].push_back(period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d - 0.1, rf_y_start, rf_z_start + adjust_height));
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d - 0.1, rf_y_start - 2 * y_direction, rf_z_start));
    ...
    times_of_rf[j].push_back(period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d - 0.2, rf_y_start - 2 * y_direction, rf_z_start));
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d - 0.2, rf_y_start - 2 * y_direction, rf_z_start + adjust_height));
    ...
    times_of_rf[j].push_back(0.2 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d - 0.2 - 0.15, rf_y_start - 2 * y_direction, rf_z_start + 0.05 + 0.2));
    ...
    start_pose.getPosition() << rf_x_start + 2 * forward_d - 0.2 - 0.15, rf_y_start - 2 * y_direction, rf_z_start + 0.05 + 0.2;
    QK.InverseKinematicsSolve(start_pose.getPosition(), LimbEnum::RF_LEG, start_joints, start_joints, "OUT_LEFT");

    final_pose.getPosition() << rf_x_start + 2 * forward_d - 0.2 + walking_dis, rf_y_start - 2 * y_direction, rf_z_start + height_2 + 0.05;// not move too long.
    QK.InverseKinematicsSolve(final_pose.getPosition(), LimbEnum::RF_LEG, final_joints, final_joints, "OUT_LEFT");
    ...
    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d - 0.2 + walking_dis, rf_y_start - 2 * y_direction, rf_z_start + height_2 + 0.05));

    times_of_rf[j].push_back(0.2 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d - 0.2 + walking_dis, rf_y_start - 2 * y_direction, rf_z_start + height_2 + adjust_height));
...
valuetype generate_lh_motion_2(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    //step 1: com moves back;
    z_start = z_start - adjust_height;
    times_of_lh[j].push_back(0);
    lh_leg_position[j].push_back(valuetype(x_start, y_start, z_start + adjust_height));
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1, y_start - 2 * y_direction, z_start + adjust_height));
    ...
    times_of_lh[j].push_back(period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.2, y_start - 2 * y_direction, z_start + adjust_height));
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d - 0.2, y_start - 2 * y_direction, z_start));
    ...
    times_of_lh[j].push_back(period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d - 0.3, y_start - 2 * y_direction, z_start));
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3, y_start , z_start + adjust_height));
    ...
    times_of_lh[j].push_back(0.25 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3, y_start, z_start + height_1 + 0.05));
    ...
    times_of_lh[j].push_back(0.5 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3 + walking_dis, y_start, z_start + height_1 + 0.05));
    ...
    times_of_lh[j].push_back(0.25 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3 + walking_dis, y_start, z_start + height_2 + adjust_height));

    lh_leg_trajectory[j].fitCurve(times_of_lh[j], lh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start + 0 * forward_d - 0.3 + walking_dis, y_start , z_start + height_2+ adjust_height;
...
valuetype generate_rh_motion_2(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(x_start, y_start, z_start + adjust_height));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1, y_start - 2 * y_direction, z_start + adjust_height));
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1,  y_start - 2 * y_direction, z_start + height_1));
    ...
    times_of_rh[j].push_back(0.5 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.2,  y_start - 2 * y_direction, z_start + height_1));
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.2,  y_start - 2 * y_direction, z_start + adjust_height));
    ...
    j = 4;
    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.2,  y_start - 2 * y_direction, z_start + height_2 + adjust_height));

    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + 0.2,  y_start - 2 * y_direction, z_start + height_2));
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + 0.1,  y_start - 2 * y_direction, z_start + height_2));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.1, y_start, z_start + height_2 + adjust_height));
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.0, y_start, z_start + height_2 + adjust_height));

    rh_leg_trajectory[j].fitCurve(times_of_rh[j], rh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start + 0 * forward_d + 0.0, y_start, z_start + height_2 + adjust_height;
...
valuetype generate_lf_motion_3(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lf_joint_positions, std::vector<valuetype>& lf_foot_position)
{
    ...
    j = 0;
    times_of_lf[j].push_back(0.0);
    lf_leg_position[j].push_back(valuetype(x_start, y_start + y_direction, z_start));

    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d, y_start + y_direction, z_start + adjust_height));
    ...
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d, y_start + y_direction, z_start + height_1));
    ...
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + 0.2, y_start + y_direction, z_start + height_1));
    ...
    times_of_lf[j].push_back(0.25 * period_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + 0.2, y_start + y_direction, z_start + adjust_height));
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start - 0 * forward_d + 0.2, y_start - y_direction, z_start));
    ...
    double stand_dis = 0.13;

    times_of_lf[j].push_back(0.0);
    lf_leg_position[j].push_back(valuetype(x_start - 0 * forward_d + 0.2, y_start - y_direction, z_start));

    times_of_lf[j].push_back(0.5 * period_t);
    lf_leg_position[j].push_back(valuetype(x_start - 0 * forward_d + 0.2, y_start - y_direction, z_start - stand_dis));
    lf_leg_trajectory[j].fitCurve(times_of_lf[j], lf_leg_position[j]);
    ...
    valuetype pos_final;
    pos_final << x_start + 0 * forward_d + 0.2, y_start - y_direction, z_start - stand_dis;
    ...
    while(dt <= 2 * (period_t + adjust_t))
    {
        ...
        }else if(dt > (period_t + adjust_t) && dt <=(period_t + 2 * adjust_t))
        {
            dt_ = dt - (period_t + adjust_t);
            lf_leg_trajectory[4].evaluate(evaluate_value, dt_);
        }else if(dt > (period_t + 2 * adjust_t) && dt <=(1.5 * period_t + 2 * adjust_t))
        {
            dt_ = dt - (period_t + 2 * adjust_t);
            lf_leg_trajectory[5].evaluate(evaluate_value, dt_);
        }else if(dt > (1.5 * period_t + 2 * adjust_t) && dt <=(2 * period_t + 2 * adjust_t))
        {
            dt_ = dt - (1.5 * period_t + 2 * adjust_t);
            lf_leg_trajectory[6].evaluate(evaluate_value, dt_);
        }else {
...
valuetype generate_rf_motion_3(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    double y_direction = 0.05;
    rf_y_start = rf_y_start - y_direction;
    ...
    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start, rf_y_start + y_direction, rf_z_start));

    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d, rf_y_start + y_direction, rf_z_start + adjust_height));
    ...
    times_of_rf[j].push_back(period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d - 0.1, rf_y_start + y_direction, rf_z_start + adjust_height));
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d - 0.1, rf_y_start - y_direction, rf_z_start));
    ...
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d - 0.1, rf_y_start - y_direction, rf_z_start - stand_dis));
    ...
    valuetype pos_final;
    pos_final << rf_x_start + 0 * forward_d - 0.1, rf_y_start - y_direction, rf_z_start - stand_dis;
    ...
    while(dt <= 2 * (period_t + adjust_t))
    {
        ...
        }else if(dt > (period_t + 2 * adjust_t) && dt <=(1.5 * period_t + 2 * adjust_t))
        {
            dt_ = dt - (period_t + 2 * adjust_t);
            rf_leg_trajectory[3].evaluate(evaluate_value, dt_);
        }else if(dt > (1.5 * period_t + 2 * adjust_t) && dt <=(2 * period_t + 3 * adjust_t))
        {
            dt_ = dt - (1.5 * period_t + 2 * adjust_t);
            rf_leg_trajectory[4].evaluate(evaluate_value, dt_);
        }else {
...
valuetype generate_lh_motion_3(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    //step 1: com moves back;
    times_of_lh[j].push_back(0);
    lh_leg_position[j].push_back(valuetype(x_start, y_start + y_direction, z_start + adjust_height));

    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d, y_start + y_direction, z_start));
    ...
    times_of_lh[j].push_back(period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d - 0.1, y_start + y_direction, z_start));
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1, y_start - y_direction, z_start + adjust_height));
    ...
    times_of_lh[j].push_back(0.5 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1, y_start - y_direction, z_start + adjust_height - stand_dis));
    ...
    times_of_lh[j].push_back(0.5 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1, y_start - y_direction, z_start - stand_dis));

    lh_leg_trajectory[j].fitCurve(times_of_lh[j], lh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start + 0 * forward_d - 0.1, y_start - y_direction, z_start - stand_dis;
...
valuetype generate_rh_motion_3(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(x_start, y_start + y_direction, z_start + adjust_height));

    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d, y_start + y_direction, z_start));
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d - 0.1, y_start + y_direction, z_start));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1, y_start - y_direction, z_start + adjust_height));
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1 - 0.05, y_start - y_direction, z_start + 0.22));
    ...
    times_of_rh[j].push_back(0.5 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1 - 0.05 + walking_dis, y_start - y_direction, z_start + 0.22));
    rh_leg_trajectory[j].fitCurve(times_of_rh[j], rh_leg_position[j]);
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1 - 0.05 + walking_dis, y_start - y_direction, z_start + height_2 - stand_dis));

    rh_leg_trajectory[j].fitCurve(times_of_rh[j], rh_leg_position[j]);


    valuetype pos_final;
    pos_final << x_start + 0 * forward_d - 0.1 - 0.05 + walking_dis, y_start - y_direction, z_start + height_2 - stand_dis;
...
valuetype generate_lf_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lf_joint_positions, std::vector<valuetype>& lf_foot_position)
{
    ...
    //step 0: rf moves forward;
    j = 0;
    double walking_dis = 0.05;

    times_of_lf[j].push_back(0.0);
    lf_leg_position[j].push_back(valuetype(x_start, y_start, z_start));

    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start - walking_dis, y_start, z_start));

    lf_leg_trajectory[j].fitCurve(times_of_lf[j], lf_leg_position[j]);


    //step 1, com moves forward;
    j = 1;
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start - walking_dis - forward_d, y_start, z_start));
    lf_leg_trajectory[j].fitCurve(times_of_lf[j], lf_leg_position[j]);

    //step 2, rh moves, others still
    j = 2;
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start - walking_dis - x_scale * forward_d, y_start + 2.5 * y_direction, z_start));
    ...
    valuetype pos_final;
    pos_final << x_start - walking_dis - x_scale * forward_d, y_start + 2.5 * y_direction, z_start;
    ...
    while(dt <= (3 * period_t + 2 * adjust_t))
    {
        if(dt <= period_t)
        {
            lf_leg_trajectory[0].evaluate(evaluate_value, dt);
        }else if(dt > period_t && dt <=(period_t + adjust_t) )
        {
            dt_ = dt - (period_t);
            lf_leg_trajectory[1].evaluate(evaluate_value, dt_);
        }else if(dt > (period_t + adjust_t) && dt <=(2 * period_t + adjust_t))
        {
            dt_ = dt - (period_t + adjust_t);
            lf_leg_trajectory[2].evaluate(evaluate_value, dt_);
...
valuetype generate_rf_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    rf_leg_position[j].push_back(valuetype(rf_x_start, rf_y_start, rf_z_start + 0.22));

    rf_leg_trajectory[j].fitCurve(times_of_rf[j], rf_leg_position[j]);

    j = 1;
    double walking_dis = 0.2;

    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start, rf_y_start, rf_z_start + 0.22));

    times_of_rf[j].push_back(0.5 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + walking_dis, rf_y_start, rf_z_start + 0.22));
    ...
    times_of_rf[j].push_back(0.25 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + walking_dis, rf_y_start, rf_z_start + height_2));
    ...
    j = 3;
    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start + walking_dis, rf_y_start, rf_z_start));

    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + walking_dis - forward_d, rf_y_start, rf_z_start));

    rf_leg_trajectory[j].fitCurve(times_of_rf[j], rf_leg_position[j]);

    //step 2: rh leg moves, other still
    j = 4;
    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start + walking_dis - forward_d, rf_y_start, rf_z_start));
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + walking_dis - x_scale * forward_d, rf_y_start + 2.5 * y_direction, rf_z_start));
    ...
    valuetype pos_final;
    pos_final << rf_x_start + walking_dis - x_scale * forward_d, rf_y_start + 2.5 * y_direction, rf_z_start;
    ...
    while(dt <= (3 * period_t + 2 * adjust_t))
    {
        ...
        {
            rf_leg_trajectory[0].evaluate(evaluate_value, dt);
        }else if(dt > 0.25 * period_t && dt <=0.75 * period_t )
        {
            dt_ = dt - 0.25 * period_t;
            rf_leg_trajectory[1].evaluate(evaluate_value, dt_);
        }else if(dt > 0.75 * period_t && dt <=period_t)
        {
...
valuetype generate_lh_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    times_of_lh[j].push_back(period_t);
    lh_leg_position[j].push_back(valuetype(x_start - 0.05, y_start, z_start));
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start - forward_d - 0.05, y_start, z_start));
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start - x_scale * forward_d - 0.05, y_start + 2.5 * y_direction, z_start));
    ...
    j = 4;
    double walking_dis = 0.3;

    times_of_lh[j].push_back(0);
    lh_leg_position[j].push_back(valuetype(x_start - x_scale * forward_d - 0.05, y_start + 2.5 * y_direction, z_start));

    times_of_lh[j].push_back(0.25 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start - x_scale * forward_d - 0.05, y_start + 2.5 * y_direction, z_start + 0.22));
    ...
    times_of_lh[j].push_back(0.5 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start - x_scale * forward_d - 0.05 + walking_dis, y_start + 2.5 * y_direction, z_start + 0.22));
    ...
    times_of_lh[j].push_back(0.25 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start - x_scale * forward_d - 0.05 + walking_dis, y_start + 2.5 * y_direction, z_start + height_2));

    lh_leg_trajectory[j].fitCurve(times_of_lh[j], lh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start - x_scale * forward_d + walking_dis - 0.05, y_start + 2.5 * y_direction, z_start + height_2;
    ...
    while(dt <= (3 * period_t + 2 * adjust_t))
    {
        ...
        }else if(dt > (2 * period_t + adjust_t) && dt <=(2 * period_t + 2 * adjust_t))
        {
            dt_ = dt - (2 * period_t + adjust_t);
            lh_leg_trajectory[3].evaluate(evaluate_value, dt_);
        }else if(dt > (2 * period_t + 2 * adjust_t) && dt <=(2.25 * period_t + 2 * adjust_t))
        {
            dt_ = dt - (2 * period_t + 2 * adjust_t);
            lh_leg_trajectory[4].evaluate(evaluate_value, dt_);
        }else if(dt > (2.25 * period_t + 2 * adjust_t) && dt <=(2.75 * period_t + 2 * adjust_t))
          {
              dt_ = dt - (2.25 * period_t + 2 * adjust_t);
              lh_leg_trajectory[5].evaluate(evaluate_value, dt_);
          }else if(dt > (2.75 * period_t + 2 * adjust_t) && dt <=(3 * period_t + 2 * adjust_t))
        {
...
valuetype generate_rh_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start - small_dis, y_start, z_start));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start - small_dis - forward_d, y_start, z_start));
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start - small_dis - forward_d, y_start, z_start + 0.2));
    ...
    times_of_rh[j].push_back(0.5 * adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start - small_dis - forward_d + walking_dis, y_start, z_start + 0.2));
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start - small_dis - forward_d + walking_dis, y_start, z_start + height_2));
   ...
   times_of_rh[j].push_back(adjust_t);
   rh_leg_position[j].push_back(valuetype(x_start - small_dis - x_scale * forward_d + walking_dis, y_start + 2.5 * y_direction, z_start + height_2));
  ...
  rh_leg_trajectory[j].fitCurve(times_of_rh[j], rh_leg_position[j]);
    ...
    valuetype pos_final;
    pos_final << x_start - small_dis - x_scale * forward_d + walking_dis, y_start + 2.5 * y_direction, z_start + height_2;
    ...
    while(dt <= (3 * period_t + 2 * adjust_t))
    {
        ...
        }else if(dt > period_t && dt <=(period_t + adjust_t) )
        {
            dt_ = dt - period_t;
            rh_leg_trajectory[1].evaluate(evaluate_value, dt_);
        }else if(dt > (period_t + adjust_t) && dt <=(1.25 * period_t + adjust_t))
        {
            dt_ = dt - (period_t + adjust_t);
            rh_leg_trajectory[2].evaluate(evaluate_value, dt_);
        }else if(dt > ( 1.25 * period_t + adjust_t) && dt <=(1.75 * period_t + adjust_t))
        {
            dt_ = dt - ( 1.25 * period_t + adjust_t);
            rh_leg_trajectory[3].evaluate(evaluate_value, dt_);
        }else if(dt > (1.75 * period_t + adjust_t) && dt <=(2 * period_t + adjust_t))
        {
...
valuetype rf_leg_stand_up(double& stand_dis, valuetype& rf_leg_pos, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    j = 0;
    double y_direction = 0.05;
    rf_leg_pos.y() = rf_leg_pos.y() - y_direction;

    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_leg_pos.x(), rf_leg_pos.y() + y_direction, rf_leg_pos.z()));
...
valuetype lh_leg_stand_up(double& stand_dis, valuetype& lh_leg_pos, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    lh_leg_trajectory.resize(step_num);
    double y_direction = 0.05;
    lh_leg_pos.y() = lh_leg_pos.y() - y_direction;

    unsigned long j = 0;

    //step 1: com moves back;
    times_of_lh[j].push_back(0);
    lh_leg_position[j].push_back(valuetype(lh_leg_pos.x(), lh_leg_pos.y() + y_direction, lh_leg_pos.z()));
...
valuetype rh_leg_stand_up(double& stand_dis, valuetype& rh_leg_pos, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    std::vector<std::vector<Time>> times_of_rh;
    std::vector<std::vector<valuetype>>rh_leg_position;
    std::vector<curves::PolynomialSplineQuinticVector3Curve> rh_leg_trajectory;
    ...
    rh_leg_trajectory.resize(step_num);
    double y_direction = 0.05;
    rh_leg_pos.y() = rh_leg_pos.y() - y_direction;    

    unsigned long j = 0;
    //step 0: com moves back;

    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(rh_leg_pos.x(), rh_leg_pos.y() + y_direction, rh_leg_pos.z()));

    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(rh_leg_pos.x(), rh_leg_pos.y(), rh_leg_pos.z() + stand_dis));
    ...
    valuetype final_pos;
    final_pos << rh_leg_pos.x(), rh_leg_pos.y(), rh_leg_pos.z() + stand_dis;
    return final_pos;
}
...
int main(int argc, char **argv)
{
    ...
    std::cout << "lf_pos_1 is " << lf_pos_1.transpose() << std::endl;
    std::cout << "rf_pos_1 is " << rf_pos_1.transpose() << std::endl;
    std::cout << "rh_pos_1 is " << rh_pos_1.transpose() << std::endl;
    std::cout << "lh_pos_1 is " << lh_pos_1.transpose() << std::endl;
    ...
    height_2 = 0.08;
    valuetype lh_pos_2 = generate_lh_motion_2(step, height_1, height_2, lh_pos_1.x(), lh_pos_1.y(), lh_pos_1.z(), lh_joint_positions, lh_foot_height);

    std::cout << "lf_pos_2 is " << lf_pos_2.transpose() << std::endl;
    std::cout << "rf_pos_2 is " << rf_pos_2.transpose() << std::endl;
    std::cout << "rh_pos_2 is " << rh_pos_2.transpose() << std::endl;
    std::cout << "lh_pos_2 is " << lh_pos_2.transpose() << std::endl;
    ...
    valuetype lh_pos_3 = generate_lh_motion_3(step, height_1, 0, lh_pos_2.x(), lh_pos_2.y(), lh_pos_2.z(), lh_joint_positions, lh_foot_height);
...
//    std::cout << "lf_stand_pos is " << lf_stand_pos.transpose() << std::endl;
//    std::cout << "rf_stand_pos is " << rf_stand_pos.transpose() << std::endl;
//    std::cout << "lh_stand_pos is " << lh_stand_pos.transpose() << std::endl;
//    std::cout << "rh_stand_pos is " << rh_stand_pos.transpose() << std::endl;
    ...
    valuetype lf_pos_4 = generate_lf_motion_4(step, height_1, 0, lf_pos_3.x(), lf_pos_3.y(), lf_pos_3.z(), lf_joint_positions, lf_foot_height);
    valuetype rf_pos_4 = generate_rf_motion_4(step, height_1, 0, rf_pos_3.x(), rf_pos_3.y(), rf_pos_3.z(), rf_joint_positions, rf_foot_height);
    valuetype rh_pos_4 = generate_rh_motion_4(step, height_1, height_2, rh_pos_3.x(), rh_pos_3.y(), rh_pos_3.z(), rh_joint_positions, rh_foot_height);
    valuetype lh_pos_4 = generate_lh_motion_4(step, height_1, height_2, lh_pos_3.x(), lh_pos_3.y(), lh_pos_3.z(), lh_joint_positions, lh_foot_height);

    std::cout << "lf_pos_4 is " << lf_pos_4.transpose() << std::endl;
    std::cout << "rf_pos_4 is " << rf_pos_4.transpose() << std::endl;
    std::cout << "rh_pos_4 is " << rh_pos_4.transpose() << std::endl;
    std::cout << "lh_pos_4 is " << lh_pos_4.transpose() << std::endl;
