...
int main(int argc, char **argv)
{
    ...
    double time_read;
    //if go upstairs;
//    readfile.open("/home/hitstar/catkin_ws/rolling_to_the_stairs_read.txt");
    //not go upstairs;
    ...
    lh_end << lh_start.x(), 0.305, lh_start.z()+adjust_height;
    rh_end << rh_start.x(), -0.305, rh_start.z()+adjust_height;
    ...
    z_height.push_back(valuetype(0, 0, rf_foot_height.back().z()));
    ...
    rh_foot_pos.clear();
    lh_foot_pos.clear();
    lf_swing_planning.clear();
    rf_swing_planning.clear();
    rh_swing_planning.clear();
    lh_swing_planning.clear();
    ...
    std::string file_name = "15_walk_and_kneel_down.txt";
    SaveAsFile(file_name, joint_positions_total);
    file_name = "15_walk_and_kneel_down_read.txt";
