...
//        std::cout << "the position is " << x_start - step_dis / 2 - forward_d << std::endl;
    ...
    times_of_rh[j].push_back(0.2 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis, y_start, z_start + height_2));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis - 0.1, y_start, z_start + height_2));
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis - 0.2, y_start, z_start + height_2));

    rh_leg_trajectory[j].fitCurve(times_of_rh[j], rh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start + 0 * forward_d + walking_dis - 0.2, y_start, z_start + height_2;
...
valuetype rh_leg_stand_up(double& stand_dis, valuetype& rh_leg_pos, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(rh_leg_pos.x(), rh_leg_pos.y(), rh_leg_pos.z()));
