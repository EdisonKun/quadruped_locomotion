...
valuetype generate_lf_motion_1(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lf_joint_positions, std::vector<valuetype>& lf_foot_position)
{
    ...
    lf_leg_position[j].push_back(valuetype(x_start - step_dis / 2 + forward_d, y_start, z_start + adjust_height));
...
//        std::cout << "final joint is " << final_joints << std::endl;
    ...
    times_of_lf[j].push_back(0.2 * period_t);
    lf_leg_position[j].push_back(valuetype(x_start + step_dis / 2 + forward_d, y_start, z_start + height_2 + adjust_height));
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + step_dis / 6 + forward_d, y_start, z_start + height_2 + adjust_height));
...
valuetype generate_rf_motion_1(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    rf_leg_position[j].push_back(valuetype(rf_x_start + step_dis / 6 + forward_d, rf_y_start, rf_z_start + adjust_height));
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start - step_dis / 2 + forward_d, rf_y_start, rf_z_start + adjust_height));
    ...
    final_pose.getPosition() << rf_x_start + 0.1 + forward_d, rf_y_start, rf_z_start + height_2 + 0.05;// not move too long.
    ...
    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0.1 + forward_d, rf_y_start, rf_z_start + height_2 + 0.05));

    times_of_rf[j].push_back(0.2 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0.1 + forward_d, rf_y_start, rf_z_start + height_2 + adjust_height));
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0.1 - forward_d, rf_y_start, rf_z_start + height_2));
    ...
    times_of_rf[j].push_back(period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start - 0.1 + 0.1 - forward_d, rf_y_start, rf_z_start + height_2));

    rf_leg_trajectory[j].fitCurve(times_of_rf[j], rf_leg_position[j]);

    valuetype pos_final;
    pos_final << rf_x_start - 0.1 + 0.1 - forward_d, rf_y_start, rf_z_start + height_2;
...
valuetype generate_lh_motion_1(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start + step_dis / 6 - forward_d, y_start, z_start + adjust_height));
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start - step_dis / 2 - forward_d, y_start, z_start + adjust_height));
...
valuetype generate_rh_motion_1(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start - step_dis / 2 - forward_d, y_start, z_start + adjust_height));
    ...
    j = 4;
    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(x_start + step_dis / 2 - forward_d, y_start, z_start + height_2 + adjust_height));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + step_dis / 6 - forward_d, y_start, z_start + height_2 + adjust_height));
...
valuetype generate_lf_motion_2(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lf_joint_positions, std::vector<valuetype>& lf_foot_position)
{
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + walking_dis - 0.1, y_start, z_start + height_2 + adjust_height));
    ...
    times_of_lf[j].push_back(period_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + walking_dis - 0.2, y_start, z_start + height_2 + adjust_height));
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis - 0.2, y_start + y_direction, z_start + height_2));
    ...
    times_of_lf[j].push_back(period_t);
    lf_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis - 0.3, y_start + y_direction, z_start + height_2));
...
//    QK.InverseKinematicsSolve(final_pose.getPosition(), LimbEnum::LF_LEG, final_joints, final_joints, "OUT_LEFT");
    ...
    valuetype pos_final;
    pos_final << x_start + walking_dis - 0.1 - 0.1 - 0.1, y_start + y_direction, z_start + height_2;
...
valuetype generate_rf_motion_2(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d - 0.2, rf_y_start, rf_z_start + adjust_height));
    ...
    times_of_rf[j].push_back(0.2 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d - 0.2 - 0.15, rf_y_start, rf_z_start + 0.05 + 0.2));
    ...
    start_pose.getPosition() << rf_x_start + 2 * forward_d - 0.2 - 0.15, rf_y_start, rf_z_start + 0.05 + 0.2;
    QK.InverseKinematicsSolve(start_pose.getPosition(), LimbEnum::RF_LEG, start_joints, start_joints, "OUT_LEFT");
    ...
    times_of_rf[j].push_back(0.2 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d - 0.2 + walking_dis, rf_y_start, rf_z_start + height_2 + adjust_height));
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d - 0.2 + walking_dis, rf_y_start + y_direction, rf_z_start + height_2));
    ...
    times_of_rf[j].push_back(period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d - 0.2 + walking_dis - 0.1, rf_y_start + y_direction, rf_z_start + height_2));
...
//    std::cout << "final_pos " << final_joints << std::endl;
    valuetype pos_final;
    pos_final << rf_x_start + 0 * forward_d - 0.2 + walking_dis - 0.1, rf_y_start + y_direction, rf_z_start + height_2;
...
valuetype generate_lh_motion_2(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    double adjust_height = -0.08;
    double walking_dis = 0.5;
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1, y_start, z_start + adjust_height));
    ...
    times_of_lh[j].push_back(period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.2, y_start, z_start + adjust_height));
    ...
    times_of_lh[j].push_back(adjust_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3, y_start + y_direction, z_start + adjust_height));
    ...
    times_of_lh[j].push_back(0.25 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3, y_start + y_direction, z_start + height_1 + 0.05));
    ...
    times_of_lh[j].push_back(0.5 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3 + walking_dis, y_start + y_direction, z_start + height_1 + 0.05));
    ...
    times_of_lh[j].push_back(0.25 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3 + walking_dis, y_start + y_direction, z_start + height_2 + adjust_height));

    lh_leg_trajectory[j].fitCurve(times_of_lh[j], lh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start + 0 * forward_d - 0.3 + walking_dis, y_start + y_direction, z_start + height_2+ adjust_height;
...
valuetype generate_rh_motion_2(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1, y_start, z_start + adjust_height));
    ...
    times_of_rh[j].push_back(0.25 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.2, y_start, z_start + adjust_height));
    ...
    j = 4;
    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.2, y_start, z_start + height_2 + adjust_height));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.1, y_start + y_direction, z_start + height_2 + adjust_height));
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + 0.0, y_start + y_direction, z_start + height_2 + adjust_height));

    rh_leg_trajectory[j].fitCurve(times_of_rh[j], rh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start + 0 * forward_d + 0.0, y_start + y_direction, z_start + height_2 + adjust_height;
...
valuetype generate_lf_motion_3(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lf_joint_positions, std::vector<valuetype>& lf_foot_position)
{
    ...
    times_of_lf[j].push_back(0.25 * period_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + 0.2, y_start, z_start + adjust_height));
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start - 0 * forward_d + 0.2, y_start, z_start + 0.05));
    ...
    times_of_lf[j].push_back(period_t);
    lf_leg_position[j].push_back(valuetype(x_start - 0 * forward_d + 0.1, y_start, z_start + 0.05));
    lf_leg_trajectory[j].fitCurve(times_of_lf[j], lf_leg_position[j]);
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + 0.1, y_start, z_start + adjust_height));
    ...
    times_of_lf[j].push_back(period_t);
    lf_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + 0, y_start, z_start + adjust_height));
    ...
    times_of_lf[j].push_back(adjust_t);
    lf_leg_position[j].push_back(valuetype(x_start - 0 * forward_d + 0, y_start, z_start+ 0.05));
...
valuetype generate_rf_motion_3(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d - 0.1, rf_y_start, rf_z_start + 0.05));
    ...
    times_of_rf[j].push_back(period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d - 0.2, rf_y_start, rf_z_start + 0.05));
    ...
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d + 0.15, rf_y_start, rf_z_start + height_1));
    ...
    times_of_rf[j].push_back(0.25 * period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d + 0.15, rf_y_start, rf_z_start + adjust_height));
    ...
    j = 6;
    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d + 0.15, rf_y_start, rf_z_start + height_2 + adjust_height));

    times_of_rf[j].push_back(adjust_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d + 0.15, rf_y_start, rf_z_start + height_2 + 0.05));
    ...
    times_of_rf[j].push_back(period_t);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 0 * forward_d + 0.05, rf_y_start, rf_z_start + height_2));

    rf_leg_trajectory[j].fitCurve(times_of_rf[j], rf_leg_position[j]);

    valuetype pos_final;
    pos_final << rf_x_start + 0 * forward_d + 0.05, rf_y_start, rf_z_start + height_2;
...
valuetype generate_lh_motion_3(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3, y_start, z_start + adjust_height + 0.1));
    ...
    times_of_lh[j].push_back(0.6 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.15, y_start, z_start + adjust_height + 0.1));
    ...
    times_of_lh[j].push_back(0.2 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.15, y_start, z_start + adjust_height));

    lh_leg_trajectory[j].fitCurve(times_of_lh[j], lh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start + 0 * forward_d - 0.15, y_start, z_start + adjust_height;
    std::cout << "the final pose is " << pos_final.z() << std::endl;
        ...
        }else if(dt > (3 * period_t + 4 * adjust_t) && dt <=(4 * period_t + 4 * adjust_t))
        {
            if(step == 3 || step == 4)
            {
                if(dt > (3 * period_t + 4 * adjust_t) && dt <=(3.2 * period_t + 4 * adjust_t))
                {
                    dt_ = dt - (3 * period_t + 4 * adjust_t);
                    lh_leg_trajectory[7].evaluate(evaluate_value, dt_);
                }else if(dt > (3.2 * period_t + 4 * adjust_t) && dt <=(3.8 * period_t + 4 * adjust_t))
                {
                    dt_ = dt - (3.2 * period_t + 4 * adjust_t);
                    lh_leg_trajectory[8].evaluate(evaluate_value, dt_);
                }else if(dt > (3.8 * period_t + 4 * adjust_t) && dt <=(4 * period_t + 4 * adjust_t))
...
valuetype generate_rh_motion_3(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(0.2 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1 - 0.05, y_start, z_start + 0.13));
...
//        std::cout << "the position is " << x_start - step_dis / 2 - forward_d << std::endl;
    ...
    Pose start_pose, final_pose;
    JointPositionsLimb start_joints, final_joints;
    start_pose.getPosition() << x_start + 0 * forward_d - 0.1 - 0.05, y_start, z_start + 0.05 + 0.08;
    QK.InverseKinematicsSolve(start_pose.getPosition(), LimbEnum::RH_LEG, start_joints, start_joints, "IN_LEFT");

    double walking_dis;
    walking_dis = 0.25;

    final_pose.getPosition() << x_start + 0 * forward_d + walking_dis, y_start, z_start + height_2 + 0.05;
    QK.InverseKinematicsSolve(final_pose.getPosition(), LimbEnum::RH_LEG, final_joints, final_joints, "IN_LEFT");
    ...
    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis, y_start, z_start + height_2 + 0.05));

    times_of_rh[j].push_back(0.2 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis, y_start, z_start + height_2 + adjust_height));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + walking_dis, y_start, z_start + height_2));
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 2 * forward_d + walking_dis - 0.1, y_start, z_start + height_2));
    ...
    times_of_rh[j].push_back(adjust_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis - 0.1, y_start, z_start + height_2 + adjust_height));
    ...
    times_of_rh[j].push_back(period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d + walking_dis - 0.2, y_start, z_start + height_2 + adjust_height));

    rh_leg_trajectory[j].fitCurve(times_of_rh[j], rh_leg_position[j]);

    valuetype pos_final;
    pos_final << x_start + 0 * forward_d + walking_dis - 0.2, y_start, z_start + height_2 + adjust_height;
...
valuetype generate_rf_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rf_joint_positions, std::vector<valuetype>& rf_foot_position)
{
    ...
    j = 6;
    times_of_rf[j].push_back(0);
    rf_leg_position[j].push_back(valuetype(rf_x_start + 2 * forward_d + 0.1, rf_y_start, rf_z_start + height_2 + adjust_height));
...
valuetype generate_lh_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    times_of_lh[j].push_back(0.2 * period_t);
    lh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.3 - 0.05, y_start, z_start + 0.05 + 0.1));
    ...
    Pose start_pose, final_pose;
    JointPositionsLimb start_joints, final_joints;
    start_pose.getPosition() << x_start + 0 * forward_d - 0.3 - 0.05, y_start, z_start + 0.05 + 0.1;
...
valuetype generate_rh_motion_4(int step, double height_1, double height_2, double height_x, double height_y, double height_z, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    times_of_rh[j].push_back(0.2 * period_t);
    rh_leg_position[j].push_back(valuetype(x_start + 0 * forward_d - 0.1 - 0.05, y_start, z_start + 0.05 + 0.1));
    ...
    Pose start_pose, final_pose;
    JointPositionsLimb start_joints, final_joints;
    start_pose.getPosition() << x_start + 0 * forward_d - 0.1 - 0.05, y_start, z_start + 0.05 + 0.1;
    QK.InverseKinematicsSolve(start_pose.getPosition(), LimbEnum::RH_LEG, start_joints, start_joints, "IN_LEFT");
...
valuetype lh_leg_stand_up(double& stand_dis, valuetype& lh_leg_pos, std::vector<JointPositionsLimb>& lh_joint_positions, std::vector<valuetype>& lh_foot_position)
{
    ...
    unsigned long j = 0;
    double adjust_height = - 0.08;
    lh_leg_pos.z() = lh_leg_pos.z() - adjust_height;
    std::cout << "lh_leg_pos.z()" << lh_leg_pos.z() <<std::endl;

    //step 1: com moves back;
    times_of_lh[j].push_back(0);
    lh_leg_position[j].push_back(valuetype(lh_leg_pos.x(), lh_leg_pos.y(), lh_leg_pos.z() + adjust_height));
...
valuetype rh_leg_stand_up(double& stand_dis, valuetype& rh_leg_pos, std::vector<JointPositionsLimb>& rh_joint_positions, std::vector<valuetype>& rh_foot_position)
{
    ...
    adjust_height = -0.08;
    rh_leg_pos.z() = rh_leg_pos.z() - adjust_height;

    unsigned long j = 0;
    //step 0: com moves back;

    times_of_rh[j].push_back(0);
    rh_leg_position[j].push_back(valuetype(rh_leg_pos.x(), rh_leg_pos.y(), rh_leg_pos.z() + adjust_height));
